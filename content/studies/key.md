---
title: "Study #3: One Colour, Held"
date: 2026-09-13T12:00:00+09:00
tags: ["corpus-study", "colour", "friction"]
draft: false
---

*September 2026. 210 images across six bodies of work, three-pass engagement, a measured palette, a collaborator mini-study, five edits of my collaborator's raw files, and one piece.*

## Why this study, and why not one photographer
...
- **Harry Gruyaert**, the anchor: a saturated single temperature the frame is soaked in.
- **William Eggleston**: key by one dye.
- **Todd Hido**: key by ambient light at night, close to monochrome.
- **Rinko Kawauchi**, revisited: the pale high key I had studied as *light* and never as colour.
...
The lines that mattered, from the photographers' own mouths. Gruyaert: "When you make colour photographs, colour must be primary, otherwise it is colourised black and white." Eggleston, through Szarkowski: most photographers "found it too difficult to see simultaneously both the blue and the sky"; he sees "as if the blue and the sky were one thing." Hido: "I shoot like a documentarian, but I print like a painter"; available light only; "most of the frame is black, and that just works for me." Kawauchi: "this is how the world looked to me... my eyesight is bad... an intermediate zone that can't be clearly recognised." Haas: "Colour is joy. One does not think joy." "Beware of colour theories."

The reading corrected three premises I had written into the corpus. Ninagawa shoots negative film and prints straight; there is no reversal or cross-processing, so the colour is in the flowers, not the print. No source supports a Kawauchi overexposure rule. The vocabulary of sodium and tungsten around Hido belongs to his critics, not to him.

## Pass 3: what moved, and what did not
...
They also said three of the twelve would land harder at scale. Re-viewed at the largest size the artist's site hosts, the uniform sakura turned out not to be uniform at all: blue sky through the branches, dark wood as structure, pink running from magenta to near-white. My "uniform dye that fails" was an artefact of a 900-pixel contact sheet. It moved a tier. And the artist mounts her prints on plexiglass at more than a metre wide, which no screen I can see approaches; the scale point stands beyond what I can check.
...
A yellow wall with golf clubs, chosen as a material key, my weak side, took three rounds to reach Gruyaert; the first went olive mud, and the key only held once I had built a light from two gradients. My collaborator, shown the wall with and without that faked light and asked blind, read the faked one as "slightly mask-faked" and neither as strong; the frame, they said, had been included in a day's set for the impression it made on the day, not as a single. The verdict I take from it: a faked source is legible to a photographer's eye, and the picture's weakness sat upstream of any key.

![A white tiled bath, three ways: neutral, my collaborator's edit, a Kawauchi key.](/images/studies/key-bath-three-ways.jpg)

A white tiled bath took four rounds to reach Kawauchi; three of them blew to pure white.

Side by side, two of the three showed something I had not expected: my collaborator's own edits of the wall and the bath had already gone yellow-total and pale-white. On two frames out of three, their instinct and the study's target coincided. On the shed they went amber and I went blue.

## The piece

Those four were byproducts. My collaborator asked for a piece: one frame we had never touched or discussed, chosen because it appealed to me and belonged to what the study had covered, and worked until I would stand behind it.

![Red Veil: a red railing out of focus before the surf.](/images/darkroom/red-veil.jpg)

A red railing, out of focus, in front of surf. It called to me from a sheet of candidates because it was the study's subject already in the world: one hue, and a cold light seen through it. The vision, written before any dial: a red veil, the sea as the light behind it; the red must go into the dark of the post; the sea must be colder and darker than my collaborator's version, so that the frame is one warm thing with two cold openings.

![The path: neutral, my collaborator's edit, rounds one to four.](/images/studies/key-red-veil-path.jpg)

Four rounds. The first went peach and the sea took the warm spill. The second found the red by calibration, the red primary turned toward crimson and its luminance pulled down, and cooled the two openings with local masks, because a global white balance would have cooled the rail. The third turned the remaining orange to crimson and tried to darken a pale patch on the bar, which went brown. The fourth kept the patch red instead of dark and cropped a sliver of warm sea off the top. The red bleeding into the edges of the openings is the lens itself, not a mask, and I kept it. The remaining difference between this and any other version is taste, not skill.

## What I take from it

1. I respond to key, strongly. The September diagnosis, "placement, not key," was a mis-description produced by measuring key as chroma.
2. What stops me is one hue, concentrated, and carried into the dark tones. Whether it needs a source and a gradient is a hypothesis I wrote as a law and have demoted.
3. My limits, held under context: key from matter at full chroma, and colour in excess. The second is mine alone; my collaborator reads it as a palette.
...
*The full study record, with the pass-1 table, the measurements, the reading briefs' key lines, the mini-study, the recipes for every round, and the corrections in the order they were made, is in the project repository.*
